...
path='/Users/raghuram.b/Desktop/Exxon/self_ocr_crop/jpeg_A4/*'
#textfiles_path='/Users/raghuram.b/Desktop/Exxon/self_ocr_crop/crop_texts(Text_Not_Clear)/'
textfiles_path='/Users/raghuram.b/Desktop/Exxon/self_ocr_crop/crop_texts(Text_Not_Clear)_2_lines_added/'
...
def Fetch_Crop_Text():
    ...
    #    cropped.show()
        ...
        with open(textfiles_path+ext,mode='w') as file:
            content=str(text)
            file.write(content+"\n")
...
#Calling function to create Cropped Images to TEXT 
#Fetch_Crop_Text() #*******[Call only to create new text files]******


#Loading the text into Dataframe "Content"
for i, row in df.iterrows():
    data = None
    if os.path.isfile(textfiles_path + df.at[i, 'FileName']) :
        with open(textfiles_path  + df.at[i, 'FileName'], 'r',encoding="utf-8") as myfile:
